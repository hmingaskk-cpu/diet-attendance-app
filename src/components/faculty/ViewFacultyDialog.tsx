...
import { DialogContent, DialogHeader, DialogTitle, DialogDescription } from "@/components/ui/dialog"; // Removed Dialog import
...
const ViewFacultyDialog = ({ isOpen, onClose, facultyMember }: ViewFacultyDialogProps) => {
  ...
  if (!facultyMember || !isOpen) { // Only render content if isOpen is true and facultyMember exists
    console.log("ViewFacultyDialog: Not rendering, isOpen or facultyMember is null.");
    return null;
  }
